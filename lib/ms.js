...
// test does not modify src;
// @todo if we keep the unshift, see if we can use sub 0 insetead= for perf.
// initial "param" should be documented as private
function mergeSort(data, _initial = false) {
  if (data.length === 2) {
